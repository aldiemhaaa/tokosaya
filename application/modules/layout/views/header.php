          ...
          <ul class="nav">
            ...
            foreach($this->session->userdata['menu'] as $menu){
              if(count($menu['submenu'])>0){
                ...
                $item.='<a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                          <span class="menu-title">'.$menu['title'].'</span>
                          <i class="menu-arrow"></i>
                          <i class="mdi '.$menu['icon'].' menu-icon"></i>
                        </a>';
                $item .= '<div class="collapse" id="ui-basic"> <ul class="nav flex-column sub-menu">';
                foreach($menu['submenu'] as $sub){
                  $item.= '<li class="nav-item"> <a class="nav-link" href="'.base_url($sub['url']).'">'.$sub['title'].'</a></li>';
                }
                $item .='</ul></div></li>';
              }else{
                $item ='<li class="nav-item">
        ...
        <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> <?= ucfirst($this->uri->segment('1')).' '.ucfirst($this->uri->segment('2')) ?>
              </h3>
